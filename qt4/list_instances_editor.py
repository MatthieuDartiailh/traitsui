...
""" Defines the various list instance editors for the PyQt user interface
toolkit.
"""
...
from traits.api import Str, Any, Bool, Dict, Callable, Instance, List
...
class SimpleEditor ( Editor ):
    ...
    #Factory function to call when a new item should be added to the list. This
    #function should take one argument a ui object. That way one can open a
    #dialog with a parent.
    ...
    def init ( self, parent ):
        ...
        #Initialize the item_factory if one was provided
        self.item_factory = self.factory.item_factory
    ...
    def add_item ( self, offset ):
        ...
        if self.item_factory:
            value = self.item_factory(self.ui)
            if value is None:
                return

            if not item_trait.validate(self, 'new_val',value):
                raise ValueError("""The provided factory does not return the
